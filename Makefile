...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/11/20 12:50:32 by mlaplana          #+#    #+#              #
#    Updated: 2020/02/06 14:55:39 by mlaplana         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libftprintf.a
SRC_PF = ft_printf.c	ft_checkflags.c		ft_itoa_hex.c \
		 ft_itoa_unsigned.c		ft_printcs.c	ft_printdiu.c	\
		 ft_printx.c	ft_put.c	ft_zerosandspaces.c	\
		 ft_condaux.c
